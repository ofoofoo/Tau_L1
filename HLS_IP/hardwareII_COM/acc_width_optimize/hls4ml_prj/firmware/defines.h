...
typedef ap_fixed<37,21> Dense_1_accum_t;
...
typedef ap_fixed<36,20> Dense_2_accum_t;
...
typedef ap_fixed<35,19> Dense_3_accum_t;
...
typedef ap_fixed<34,18> Dense_4_accum_t;
...
typedef ap_fixed<34,18> Dense_5_accum_t;
...
typedef ap_fixed<37,18> Dense_6_accum_t;
